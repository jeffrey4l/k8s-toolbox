...
func (c *FakeStudents) UpdateStatus(ctx context.Context, student *v1.Student, opts metav1.UpdateOptions) (*v1.Student, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(studentsResource, "status", c.ns, student), &v1.Student{})
