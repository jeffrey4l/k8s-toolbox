...
type StudentInterface interface {
	...
	UpdateStatus(ctx context.Context, student *v1.Student, opts metav1.UpdateOptions) (*v1.Student, error)
...
func newStudents(c *XcodestV1Client, namespace string) *students {
	return &students{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *students) UpdateStatus(ctx context.Context, student *v1.Student, opts metav1.UpdateOptions) (result *v1.Student, err error) {
	result = &v1.Student{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("students").
